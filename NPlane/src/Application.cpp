...
void Application::update() {
	...
	transform = perspective*lookAt* rotY * rotX;
}
...
void Application::mouse(double posx, double posy)
{
	rotX = glm::rotate(glm::mat4(1.0f), glm::radians((float)posx/2.88f),glm::vec3(0.0f,1.0f,0.0f));
	rotY = glm::rotate(glm::mat4(1.0f), glm::radians((float)posx / (1024 / 360)), glm::vec3(1.0f, 0.0f, 0.0f));
}